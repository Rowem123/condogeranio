...
<tr>
	...
	<td><?php $x=new m_casas(); $a= $x ->leer_casa_residente($value['id_persona']); echo $a['nombres']." ".$a['apellidos'];?></td>
	<td><?php switch ($value['estado_casa']) { case 0: echo "En venta"; break; case 1: echo "En alquiler";break;} ?></td>
	...
	<td><a href="controlador/c_casas.php?id=<?php echo $value['id_casa']; ?>&accion=eliminar"><img src="images/eliminar.png" alt="eliminarr" width="20" height="20"></a></td>
...
if (isset($_REQUEST['id']))
    {
      $id= $_REQUEST['id'];
      	...
      	elseif ($id==1) 
      	{
      		echo '<div class="alert alert-danger w-50 mx-auto" role="alert"> Se ha registrado correctamente</div>';
      	}
      	elseif ($id==2) 
      	{
