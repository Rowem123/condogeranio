...
<tr>
        ...
        <td><?php $x=new m_empleados(); $a= $x ->leer_datos_empleado($value['id_persona']); echo $a['nombres'];?></td>
	...
	<td><a href="controlador/c_empleados.php?id=<?php echo $value['id_empleado']; ?>&accion=eliminar"><img src="images/eliminar.png" alt="eliminarr" width="20" height="20"></a></td>
</tr>
<?php
}
}
