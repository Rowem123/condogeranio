...
<tr>
	...
	<td><a href="controlador/c_gastos.php?id=<?php echo $value['id_gasto']; ?>&accion=eliminar_gasto"><img src="images/eliminar.png" alt="eliminarr" width="20" height="20"></a></td>
