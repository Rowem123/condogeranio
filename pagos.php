...
<tr>
	...
	<td><?php $x=new m_pagos(); $a= $x ->leer_pago_persona($value['id_persona']); echo $a['nombres']." ".$a['apellidos'];?></td>
	...
	<td><a href="controlador/c_pagos.php?id=<?php echo $value['id_pago']; ?>&accion=eliminar"><img src="images/eliminar.png" alt="eliminarr" width="20" height="20"></a></td>
