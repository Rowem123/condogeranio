...
<tr>
	...
	<td><?php $x=new m_reclamos(); $a= $x ->leer_nombre_perfil($value['id_persona']); echo $a['nombres']." ".$a['apellidos'];?></td>
	...
	<td><a href="controlador/c_reclamos.php?id=<?php echo $value['id_reclamo']; ?>&accion=eliminar"><img src="images/eliminar.png" alt="eliminarr" width="20" height="20"></a></td>
</tr>
<?php
}
}
