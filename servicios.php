...
<tr>
	<td scope="row"><?php echo $value['id_servicio']; ?></td>
        ...
        <td><?php $monto_bs=$value['monto_dolar']*$dolar['precio_dolar']; echo $monto_bs; ?></td>
	...
	<td><a href="controlador/c_gastos.php?id=<?php echo $value['id_servicio']; ?>&accion=eliminar"><img src="images/eliminar.png" alt="eliminarr" width="20" height="20"></a></td>
...
if (isset($_REQUEST['id']))
      ...
      $id= $_REQUEST['id'];
        ...
        elseif ($id==6) 
      	{
      		echo '<div class="alert alert-success w-50 mx-auto" role="alert"> Se ha cambiado el precio correctamente</div>';
      	}
        elseif ($id==7) 
      	{
      		echo '<div class="alert alert-danger w-50 mx-auto" role="alert"> Ha ocurrido un error al cambiar el precio</div>';
      	}
    	}
?>
</article>
