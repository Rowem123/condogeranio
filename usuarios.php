...
<tr>
	<td scope="row"><?php echo $value['id_usuario']; ?></td>
        <td><?php if($value['tipo_usuario']==='1') { echo "Administrador"; } else { echo "Residente"; } ?></td>
        <td><?php $x=new m_usuarios(); $a= $x ->leer_datos_usuario($value['id_persona']); echo $a['nombres']." ".$a['apellidos']; ?></td>
	...
	<td><a href="controlador/c_usuarios.php?id=<?php echo $value['id_usuario']; ?>&accion=Eliminar"><img src="images/eliminar.png" alt="eliminarr" width="20" height="20"></a></td>
</tr>
<?php
}
}
